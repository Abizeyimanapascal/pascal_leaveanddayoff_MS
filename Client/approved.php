        ...
        <div class="text-center bg-light fixed-top row text-muted shadow" style="transition:transform 3s ease-in;border-bottom:4px solid #2ea3f2">
                            ...
                            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
                                <li class="nav-item">
                                    <a class="snav-link py-4 ms-5" href="request.php">REQUEST
                                        <div class="badge bg-light text-warning"><?php //echo $row; 
                                                                                    ?></div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="snav-link py-4 ms-5" href="approved.php" style="color: black;">APPROVED
                                        <div class="badge bg-primary text-light">5<?php //echo $row1; 
                                                                                    ?></div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="snav-link py-4 ms-5" href="rejected.php">REJECTED
                                        <div class="badge bg-danger text-light">4<?php //echo $row3; 
                                                                                    ?></div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="snav-link py-4 ms-5" href="status.php">STATUS
                                        <div class="badge bg-light text-info"><?php //echo $row4; 
                                                                                ?></div>
                                    </a>
                                </li>
                            </ul>
            ...
            <div class="col-1 dropdown py-4">
                ...
                <ul class="dropdown-menu text-small">
                    ...
                    <li>
                        <Link to="/" className='dropdown-item nav-a text-dark'>Sign out</Link>
                    </li>
                </ul>
            </div>
