    ...
    <div class="text-center fixed-top row bg-light text-muted shadow"  style="transition:transform 3s ease-in;">
      ...
      <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0 justify-content-center">              
            <li class="nav-item">      
            <a class="btn btn-outline-warning py-4" href="waitinguploads.php">Waiting Uploads 
              <div class="badge bg-light text-warning"><?php echo $row; ?></div>
            </a>
            </li> 
            <li class="nav-item">
              <a class="btn btn-outline-success py-4 ms-3" href="availablehouse.php">Available Houses
              <div class="badge bg-light text-success"><?php echo $row1; ?></div>
              </a>
            </li>
            <li class="nav-item">
              <a class="btn btn-outline-primary py-4 ms-3" href="landloads.php">Landlords
              <div class="badge bg-light text-primary"><?php echo $row2; ?></div>
              </a>
            </li>
            <li class="nav-item">
              <a class="btn btn-outline-danger py-4 ms-3" href="pendingorders.php">Pending Orders
              <div class="badge bg-light text-danger"><?php echo $row3; ?></div>
              </a>
            </li>
            <li class="nav-item">
              <a class="btn btn-outline-secondary py-4 ms-3" href="messages.php">Messages
              <div class="badge bg-light text-secondary"><?php echo $row4; ?></div>
              </a>
            </li>
            <li class="nav-item">
              <a class="btn btn-outline-info py-4 ms-3" href="history.php">History
              <div class="badge bg-light text-info"><?php echo $row5; ?></div>
              </a>
            </li>
          </ul>
        </div>
