        ...
        <div class="container">
            ...
            <div class="" style="width:1110px;">
                <div class="alert p-color text-light h6 row">
                    ...
                    <div class="col-4">Rejection Reason</div>
                ...
                $sql = "SELECT * FROM leave_requests INNER JOIN `staff` ON leave_requests.staff_id = staff.staff_id WHERE decision='Rejected'";
                ...
                ?>
                        <div class="alert alert-dark text-muted row">
                            ...
                            <div class="col-4"><?php echo $row['decision_reason'] ?></div>
                ...
                <?php
                    ...
                    echo "<p>No rejected leave requests.</p>";
                }
