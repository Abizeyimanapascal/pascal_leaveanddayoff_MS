        ...
        <div class="container">
            ...
            <div class="" style="width:1110px;">
                <div class="alert p-color text-light h6 row">
                    ...
                    <div class="col-5">Request Reason</div>
                ...
                $sql = "SELECT * FROM day_off_requests INNER JOIN `staff` ON day_off_requests.staff_id = staff.staff_id WHERE decision='Pending'";
                ...
                ?>
                        <div class="alert alert-dark text-muted row">
                            <div class="col-3"><?php echo $row['first_name']." ".$row['other_name'] ?></div>
                            <div class="col-5"><?php echo $row['day_off_reason'] ?></div>
                            <div class="col-2"><?php echo $row['day_off_date'] ?></div>
                            <div class="col text-danger col-2">
                                <a href="approvedayoff.php? request_id=<?php echo $row['request_id'] ?>" class="link text-secondary ms-2" style="text-decoration:none;" title="Approve this request" onclick="return confirm('Approve this request?')"><b>Approve</b></a>
                                <a href="rejectdayoff.php? request_id=<?php echo $row['request_id'] ?>" class="link text-danger ms-2" style="text-decoration:none;" title="Reject this request" onclick="return confirm('Reject this request?')"><b>Reject</b></a>  
                            </div>
                        </div>
