        ...
        <div class="container">
            ...
            <div class="" style="width:1110px;">
                <div class="alert p-color text-light h6 row">
                    ...
                    <div class="col-6">Request Reason</div>
                ...
                $sql = "SELECT * FROM day_off_requests INNER JOIN `staff` ON day_off_requests.staff_id = staff.staff_id WHERE decision='Approved'";
                ...
                ?>
                        <div class="alert alert-dark text-muted row">
                            ...
                            <div class="col-6"><?php echo $row['day_off_reason'] ?></div>
                ...
                <?php
                    ...
                    echo "<p>No Approved day off request found.</p>";
                }
