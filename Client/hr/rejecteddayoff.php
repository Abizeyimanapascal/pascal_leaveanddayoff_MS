        ...
        <div class="container">
            ...
            <div class="" style="width:1110px;">
                <div class="alert p-color text-light h6 row">
                    ...
                    <div class="col-6">Rejection Reason</div>
                    <div class="col-2">Day off Date</div>
                ...
                $sql = "SELECT * FROM day_off_requests INNER JOIN `staff` ON day_off_requests.staff_id = staff.staff_id WHERE decision='Rejected'";
                ...
                ?>
                        <div class="alert alert-dark text-muted row">
                            ...
                            <div class="col-6"><?php echo $row['decision_reason'] ?></div>
                            <div class="col-2"><?php echo $row['day_off_date'] ?></div>
                            <div class="col-2"><?php echo $row['created_at'] ?></div>
                        </div>

                <?php
                    }
                } else {
                    echo "<p>No Rejected day off request found.</p>";
                }
