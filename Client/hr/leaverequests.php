  ...
  ================================================== -->
        ...
        <div class="container">
            ...
            <div class="" style="width:1110px;">
                ...
                $sql = "SELECT * FROM leave_requests INNER JOIN `staff` ON leave_requests.staff_id = staff.staff_id WHERE decision='Pending'";
                ...
                ?>
                        <div class="alert alert-dark text-muted row">
                            ...
                            <div class="col text-danger col-2">
                                <a href="approveleave.php? request_id=<?php echo $row['request_id'] ?>" class="link text-secondary ms-2" style="text-decoration:none;" title="Approve this request" onclick="return confirm('Approve this request?')"><b>Approve</b></a>
                                <a href="rejectleave.php? request_id=<?php echo $row['request_id'] ?>" class="link text-danger ms-2" style="text-decoration:none;" title="Reject this request"  onclick="return confirm('Reject this request?')"><b>Reject</b></a>  
                            </div>
                        </div>
